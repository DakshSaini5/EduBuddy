...
try {
    ...
    $user_college = $currentUserData['college'] ?? null;
    ...
    $sql = "
        SELECT
            ...
            IF(? IS NOT NULL AND u.college = ? AND u.college != '', 10, 0) AS college_boost,
    ...
    $stmt->execute([
        ...
        $user_college,      // for college_boost IS NOT NULL check
        $user_college,      // for college_boost equality check
